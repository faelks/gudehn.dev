...
import { Container, Header, Layout, PostsTable, Stack, SubHeading, Break, TextBlock } from "../components";
        ...
        <Stack xPadding="medium" margin="medium">
          <Stack margin="medium">
            <TextBlock>
              Hi!
              <br />
              I'm Felix and work as a software developer. Checkout <Link to="/projects">my work</Link>&nbsp;or have a
              read through one of my <Link to="/blog">blog posts</Link>. You can find ways to reach me <Link to="/about">here</Link>.
            </TextBlock>
            <TextBlock>
