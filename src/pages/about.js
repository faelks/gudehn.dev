  ...
  <Layout>
    ...
    <Container>
      <Stack xPadding="large" yPadding="large" margin="medium">
        <TextBlock>
          Hi! I'm a software engineer currently living with my girlfriend in Sydney, Australia.
        </TextBlock>
        <TextBlock>
          I've spent the last few years working full time in my first full-time gig out of
          University where I did a B.Sc. of IT, graduating in 2018. After graduating I worked
          for as a Research Assistant for a time which was the followed by my last role at&nbsp;
